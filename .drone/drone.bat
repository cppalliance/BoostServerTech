...
git clone https://github.com/boostorg/boost.git -b %DRONE_COMMIT_BRANCH% boost
cd boost
...
cd libs
git clone https://github.com/CppAlliance/buffers.git -b %DRONE_COMMIT_BRANCH% buffers
git clone https://github.com/CppAlliance/http_proto.git -b %DRONE_COMMIT_BRANCH% http_proto
git clone https://github.com/CppAlliance/http_io.git -b %DRONE_COMMIT_BRANCH% http_io
cd ..
